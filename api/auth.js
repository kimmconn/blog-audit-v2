...
export default async function handler(req, res) {
  ...
  if (code) {
    try {
      ...
      // Google only sends a refresh_token on some authorizations — never overwrite an existing
      // valid one with null if this particular response happens not to include one.
